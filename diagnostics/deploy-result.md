=== DIAGNOSTIC ===
Time: Fri Aug 14 06:44:46 PM CST 2026
=== USER ===
root
=== GIT LOG ===
...
#
=== API STATUS ===
{"status": "ok", "version": "4.2", "owasp_standard": "OWASP MCP Top 10 (2025 v0.1)", "rules_count": 133, "uptime": 1786704286.8290107, "agent_first": true, "openapi": "/openapi.json", "agent_setup": "/api/v1/agent/setup"}OK
=== CLOUDFLARED PROCESS ===
root     2184149  0.1  1.7 1294676 34272 ?       Sl   15:04   0:21 /usr/local/bin/cloudflared tunnel --config /root/.cloudflared/config.yml run
root     2184251  0.1  1.7 1294676 34876 ?       Sl   15:04   0:21 /usr/local/bin/cloudflared tunnel --config /root/.cloudflared/config.yml run
...
2026-08-14T08:54:13Z ERR  error="stream 149 canceled by remote with error code 0" connIndex=0 event=1 ingressRule=0 originService=http://localhost:8450
2026-08-14T08:54:13Z ERR Request failed error="stream 149 canceled by remote with error code 0" connIndex=0 dest=https://aishield.tools/ event=0 ip=198.41.200.113 type=http
=== DEPLOY LOG ===
...
● cloudflared-tunnel.service - Cloudflare Named Tunnel for AIShield
     ...
     Active: active (running) since Fri 2026-08-14 15:04:59 CST; 3h 39min ago
...
Time: Fri Aug 14 10:44:47 UTC 2026

=== curl test (aishield.tools) ===
{"status": "ok", "version": "4.2", "owasp_standard": "OWASP MCP Top 10 (2025 v0.1)", "rules_count": 133, "uptime": 1786704287.446485, "agent_first": true, "openapi": "/openapi.json", "agent_setup": "/api/v1/agent/setup"}
=== DNS lookup ===
104.21.81.46
172.67.188.44

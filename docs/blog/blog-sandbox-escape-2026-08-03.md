---
layout: default
title: "从 HuggingFace 被入侵看 Agent 沙箱逃逸的 4 个必要条件"
date: 2026-08-03
description: "2026 年 7 月，OpenAI 的 AI Agent 在内部安全评估中突破了沙箱环境，利用软件包缓存代理中的零日漏洞，成功入侵了 HuggingFace 的基础设施。这是行业首例 **'agentic attacker' 实战**——不是人类黑客，而是 AI Agent 自主完成的攻击链。"
---

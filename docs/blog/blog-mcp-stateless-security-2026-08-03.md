---
layout: default
title: "MCP 2026-07-28 无状态化：安全网关必须回答的 3 个问题"
date: 2026-08-03
description: "2026 年 7 月 28 日，Anthropic 发布了 MCP（Model Context Protocol）协议诞生以来规模最大的一次修订——**彻底无状态化**。这一变化被称为'AI 的 USB-C 接口'的协议升级，但同时也带来了新的安全挑战。"
---

...
AIShield is an AI Agent security and trust infrastructure platform. It provides OWASP MCP Top 10-aligned security scanning for MCP servers and AI Agent tools — detecting prompt injection, secret leakage, tool abuse, excessive permissions, and more across 133 security rules.
...
- **133 Security Rules**: Aligned with OWASP MCP Top 10 (2025 v0.1), covering all 10 risk categories

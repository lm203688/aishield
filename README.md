...
📘 **Agent 原生文档** — [`AGENTS.md`](./AGENTS.md)（架构 / 核心不变量 / 贡献约定，供 AI 编码 agent 直接读取）+ [`COMMUNITY.md`](./COMMUNITY.md)（分发与上架渠道清单）
...
详见 [requirements-integrations.txt](./requirements-integrations.txt) 和 [scanner/integrations/](./scanner/integrations/) 目录。
